...
const imageSeed = [
  ...
  },
  {
    ...
    image:
      '/assets/images/21.jpgassets/img/gallery/4848Eldred/20-667290_13_0.jpeg',
    rating: 0,
    date: new Date(Date.now())
  },
  {
    description: 'Giraffe',
    image:
      '/assets/img/gallery/5637SpreadingOak/d75523f2eec32757814621837cb42694l-m2001593535xd-w1020_h770_q80.jpeg',
    rating: 0,
    date: new Date(Date.now())
  },
  {
...
.then( () => {
  ...
  /* .then((data) => {
    `${data.result.n} records inserted`;
  })
  .catch((err) => {
    console.error(err);
    process.exit(1);
